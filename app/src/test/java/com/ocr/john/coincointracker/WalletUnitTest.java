package com.ocr.john.coincointracker;
...
public class WalletUnitTest {
    ...
    public void createWallet() throws Exception {
        ...
        assertEquals(45, wallet.getBalance(),0.001);
    }
    ...
    public void testWalletContent() throws Exception {
        ...
        AuthActivity auth = mock(AuthActivity.class);
        when(auth.getUserToken()).thenReturn("FakeToken");
